 ...
 <nav class="sidebar sidebar-offcanvas" id="sidebar">
     <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
         <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('assets/img/ABSEN KARYAWAN.png') }}"
                 alt="logo" /></a>
         <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="{{ asset('assets/img/absen.png') }}"
                 alt="logo" /></a>
     </div>
     <ul class="nav">
             ...
             <li class="nav-item menu-items">
                 ...
                 <div class="collapse" id="ui-basic">
                     <ul class="nav flex-column sub-menu">
                         ...
                         <li class="nav-item"> <a class="nav-link" href="/absenmasuk">Kelola Data Absen Masuk</a></li>
                         <li class="nav-item"> <a class="nav-link" href="/absenkeluar">Kelola Data Absen Keluar</a></li>
                         {{-- <li class="nav-item"> <a class="nav-link" href="/absenmasuk">Kelola Data absen masuk</a></li>
                         <li class="nav-item"> <a class="nav-link" href="/absenkeluar">Kelola Data absen keluar</a></li> --}}
                     </ul>
                 </div>
